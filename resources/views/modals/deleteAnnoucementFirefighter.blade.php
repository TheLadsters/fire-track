...
<div id="editAnnouncementFirefighter" class="modal fade deleteAnnouncementFirefighter">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <form method="POST" action="{{route('firefighter.deleteAnnouncementFirefighter')}}" enctype="multipart/form-data">
                @csrf
